...
export const JobAggregateSchema = z.object({
  orderBy: z
    .union([
  ...
  _count: z
    .union([z.literal(true), JobCountAggregateInputObjectSchema])
    .optional(),
  _min: JobMinAggregateInputObjectSchema.optional(),
  _max: JobMaxAggregateInputObjectSchema.optional(),
  _avg: JobAvgAggregateInputObjectSchema.optional(),
  _sum: JobSumAggregateInputObjectSchema.optional(),
});
