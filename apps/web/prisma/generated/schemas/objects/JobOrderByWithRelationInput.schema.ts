...
import { EmployerOrderByWithRelationInputObjectSchema } from "./EmployerOrderByWithRelationInput.schema";
import { TagOrderByRelationAggregateInputObjectSchema } from "./TagOrderByRelationAggregateInput.schema";
import { JobSeekerOrderByRelationAggregateInputObjectSchema } from "./JobSeekerOrderByRelationAggregateInput.schema";

import type { Prisma } from "@prisma/client";

const Schema: z.ZodType<Prisma.JobOrderByWithRelationInput> = z
  .object({
    ...
    employer: z
      .lazy(() => EmployerOrderByWithRelationInputObjectSchema)
      .optional(),
    tags: z.lazy(() => TagOrderByRelationAggregateInputObjectSchema).optional(),
    savedBy: z
      .lazy(() => JobSeekerOrderByRelationAggregateInputObjectSchema)
      .optional(),
    applicants: z
      .lazy(() => JobSeekerOrderByRelationAggregateInputObjectSchema)
      .optional(),
...
export const JobOrderByWithRelationInputObjectSchema = Schema;
