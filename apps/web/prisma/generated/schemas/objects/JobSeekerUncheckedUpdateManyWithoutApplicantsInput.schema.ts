...
const Schema: z.ZodType<Prisma.JobSeekerUncheckedUpdateManyWithoutApplicantsInput> =
  z
    .object({
      firstName: z
        .union([
...
export const JobSeekerUncheckedUpdateManyWithoutApplicantsInputObjectSchema =
  Schema;
