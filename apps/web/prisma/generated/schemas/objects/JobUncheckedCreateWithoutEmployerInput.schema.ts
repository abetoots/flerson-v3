...
import { JobSeekerUncheckedCreateNestedManyWithoutAppliedInputObjectSchema } from "./JobSeekerUncheckedCreateNestedManyWithoutAppliedInput.schema";

import type { Prisma } from "@prisma/client";

const Schema: z.ZodType<Prisma.JobUncheckedCreateWithoutEmployerInput> = z
  .object({
    ...
    applicants: z
      .lazy(
        () => JobSeekerUncheckedCreateNestedManyWithoutAppliedInputObjectSchema
      )
      .optional(),
  })
  .strict();

export const JobUncheckedCreateWithoutEmployerInputObjectSchema = Schema;
