...
const Schema: z.ZodType<Prisma.JobSeekerUncheckedUpdateManyWithoutAppliedNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const JobSeekerUncheckedUpdateManyWithoutAppliedNestedInputObjectSchema =
  Schema;
