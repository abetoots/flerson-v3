...
const Schema: z.ZodType<Prisma.JobCountAggregateInputType> = z
  .object({
    ...
    employmentType: z.literal(true).optional(),
    ...
    tagIds: z.literal(true).optional(),
    datePosted: z.literal(true).optional(),
    updatedAt: z.literal(true).optional(),
    savedByIds: z.literal(true).optional(),
    applicantIds: z.literal(true).optional(),
...
export const JobCountAggregateInputObjectSchema = Schema;
