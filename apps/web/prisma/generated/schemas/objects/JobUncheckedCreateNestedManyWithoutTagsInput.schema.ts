...
const Schema: z.ZodType<Prisma.JobUncheckedCreateNestedManyWithoutTagsInput> = z
  .object({
    create: z
      .union([
...
export const JobUncheckedCreateNestedManyWithoutTagsInputObjectSchema = Schema;
