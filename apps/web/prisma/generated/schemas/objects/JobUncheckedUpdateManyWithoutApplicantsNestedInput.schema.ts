...
const Schema: z.ZodType<Prisma.JobUncheckedUpdateManyWithoutApplicantsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => JobUpdateManyWithWhereWithoutApplicantsInputObjectSchema
          ),
          z
            .lazy(
              () => JobUpdateManyWithWhereWithoutApplicantsInputObjectSchema
...
export const JobUncheckedUpdateManyWithoutApplicantsNestedInputObjectSchema =
  Schema;
