...
const Schema: z.ZodType<Prisma.TagUncheckedCreateNestedManyWithoutJobsInput> = z
  .object({
    create: z
      .union([
...
export const TagUncheckedCreateNestedManyWithoutJobsInputObjectSchema = Schema;
