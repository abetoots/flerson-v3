...
import { TagUncheckedUpdateManyWithoutJobsNestedInputObjectSchema } from "./TagUncheckedUpdateManyWithoutJobsNestedInput.schema";
...
const Schema: z.ZodType<Prisma.JobUncheckedUpdateWithoutApplicantsInput> = z
  .object({
    title: z
      .union([
        z.string(),
    ...
    highlight: z
      ...
      .nullable(),
    tags: z
      .lazy(() => TagUncheckedUpdateManyWithoutJobsNestedInputObjectSchema)
      .optional(),
    savedBy: z
      .lazy(
        () =>
...
export const JobUncheckedUpdateWithoutApplicantsInputObjectSchema = Schema;
