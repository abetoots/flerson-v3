...
const Schema: z.ZodType<Prisma.JobUpdateManyWithoutEmployerNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => JobUpsertWithWhereUniqueWithoutEmployerInputObjectSchema),
        z
          .lazy(() => JobUpsertWithWhereUniqueWithoutEmployerInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => JobUpdateWithWhereUniqueWithoutEmployerInputObjectSchema),
        z
          .lazy(() => JobUpdateWithWhereUniqueWithoutEmployerInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const JobUpdateManyWithoutEmployerNestedInputObjectSchema = Schema;
