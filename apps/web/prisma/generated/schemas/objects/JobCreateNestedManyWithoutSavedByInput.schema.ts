...
const Schema: z.ZodType<Prisma.JobCreateNestedManyWithoutSavedByInput> = z
  .object({
    create: z
      .union([
        ...
        z.lazy(() => JobUncheckedCreateWithoutSavedByInputObjectSchema).array(),
      ])
      .optional(),
    connectOrCreate: z
      .union([
        z.lazy(() => JobCreateOrConnectWithoutSavedByInputObjectSchema),
        z.lazy(() => JobCreateOrConnectWithoutSavedByInputObjectSchema).array(),
      ])
      .optional(),
    connect: z
      .union([
...
export const JobCreateNestedManyWithoutSavedByInputObjectSchema = Schema;
