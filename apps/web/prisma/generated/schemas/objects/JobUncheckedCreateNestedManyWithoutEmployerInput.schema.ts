...
const Schema: z.ZodType<Prisma.JobUncheckedCreateNestedManyWithoutEmployerInput> =
  z
    .object({
      create: z
        .union([
...
export const JobUncheckedCreateNestedManyWithoutEmployerInputObjectSchema =
  Schema;
