...
const Schema: z.ZodType<Prisma.JobUncheckedCreateNestedManyWithoutApplicantsInput> =
  z
    .object({
      create: z
        .union([
...
export const JobUncheckedCreateNestedManyWithoutApplicantsInputObjectSchema =
  Schema;
