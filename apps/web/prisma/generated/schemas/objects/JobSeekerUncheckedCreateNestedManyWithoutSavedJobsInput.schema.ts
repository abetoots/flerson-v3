...
const Schema: z.ZodType<Prisma.JobSeekerUncheckedCreateNestedManyWithoutSavedJobsInput> =
  z
    .object({
      create: z
        .union([
...
export const JobSeekerUncheckedCreateNestedManyWithoutSavedJobsInputObjectSchema =
  Schema;
