...
const Schema: z.ZodType<Prisma.JobUncheckedUpdateManyWithoutSavedJobsInput> = z
  .object({
    title: z
      .union([
        z.string(),
...
export const JobUncheckedUpdateManyWithoutSavedJobsInputObjectSchema = Schema;
