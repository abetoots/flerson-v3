...
const Schema: z.ZodType<Prisma.JobSeekerCreateNestedManyWithoutAppliedInput> = z
  .object({
    create: z
      .union([
...
export const JobSeekerCreateNestedManyWithoutAppliedInputObjectSchema = Schema;
