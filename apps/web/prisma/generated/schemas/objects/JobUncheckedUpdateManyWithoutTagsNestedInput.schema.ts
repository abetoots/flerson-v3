...
const Schema: z.ZodType<Prisma.JobUncheckedUpdateManyWithoutTagsNestedInput> = z
  .object({
    create: z
      .union([
...
export const JobUncheckedUpdateManyWithoutTagsNestedInputObjectSchema = Schema;
